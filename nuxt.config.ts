  ...
  app: {
    ...
    head: {
      ...
      meta: [
        ...
        { property: "og:image", content: "https://k7y.space/gitreader-landing/screenshots/gitreader-library.jpg" },
        { property: "og:image:width", content: "1400" },
        { property: "og:image:height", content: "900" },
        { name: "twitter:card", content: "summary_large_image" },
        { name: "twitter:image", content: "https://k7y.space/gitreader-landing/screenshots/gitreader-library.jpg" },
      ],
