...
Public website for GitReader, a native repository research workspace for macOS.
...
GitHub Pages hosts this repository at `/git-reader/`, so validate that base path before publishing:

```sh
NUXT_APP_BASE_URL=/git-reader/ npm run generate
```
